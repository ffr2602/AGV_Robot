...
class robot():
    ...
    def main_robot(self):
        while True:
            ...
            set_single_discrete_input(slave_map_io['map_io']['dashboard']['state']['running']['addr'], True)
            set_single_discrete_input(slave_map_io['map_io']['dashboard']['state']['out_of_track']['addr'], not (self.canbus.flag >> 1) & 1)
            set_single_discrete_input(slave_map_io['map_io']['dashboard']['alarm']['estop_area']['addr'], self.bumper)
            set_single_discrete_input(slave_map_io['map_io']['dashboard']['alarm']['alarm_fault']['addr'], self.fault_alarm)
            set_single_input_register(slave_map_io['map_io']['dashboard']['rfid']['addr'], self.canbus.data_RFID)
            set_multiple_input_registers(slave_map_io['map_io']['dashboard']['clock']['hour']['addr'], get_uptime())
            # ======================================
            # ================= CALIBRATION MAGNET ======================================
            # =======================================================
            set_multiple_input_registers(slave_map_io['map_io']['setting']['sensor']['magnet']['left']['addr'], [int16_to_registers(self.canbus.sensor[0]), int16_to_registers(self.canbus.sensor[2])])
            if get_single_coil(slave_map_io['map_io']['setting']['sensor']['magnet']['calibration']['addr']):
                self.canbus.calibrate_sensor_magnet()
                set_single_coil(slave_map_io['map_io']['setting']['sensor']['magnet']['calibration']['addr'], False)
            # ======================================
            # ================= CALIBRATION RFID ======================================
            # =======================================================
            set_single_holding_register(slave_map_io['map_io']['setting']['sensor']['rfid']['actual_rfid']['addr'], self.canbus.data_RFID)
            if get_single_coil(slave_map_io['map_io']['setting']['sensor']['rfid']['calibration']['addr']):
                set_RFID(get_single_holding_register(slave_map_io['map_io']['setting']['sensor']['rfid']['set_rfid']['addr']))
                set_single_coil(slave_map_io['map_io']['setting']['sensor']['rfid']['calibration']['addr'], False)
            # ======================================
            # ================= CONFIGURATION ======================================
            # =======================================================
            if get_single_coil(slave_map_io['map_io']['setting']['save']['addr']):
                save_config()
                set_single_coil(slave_map_io['map_io']['setting']['save']['addr'], False)
            # ======================================
            # ================= ALARM FAULT ======================================
            # =======================================================
            if not self.cc___er[0] or not self.cc___er[1] or self.canbus.error[0] != 0 or self.canbus.error[1] != 0 or self.canbus.temp_driver >= 80:
